...
public class Book04Dto {
	...
	public Author04Dto[] getAuthors() {
		return authors;
	}

	public void setAuthors(Author04Dto[] authors) {
	...
	public String toString() {
		...
		builder.append("Book04Dto [bookId=");
