 ...
 *************************************************************/
@RestController
public class TMAuthor01 implements IBaseTM<Author01Request, Author01Response> {
	private String className = getClass().getName();
	private Logger logger = LoggerFactory.getLogger(className);
	private IBasePM<Author01Request, Author01Response> pm = new PMAuthor01();
	...
	* Search author by name
	 ...
	 * @return Author array
	 *************************************************************/
	@RequestMapping(value = "/freebookstore/api/v2/search-author-by-id", //
			method = RequestMethod.POST, //
			produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	public BaseRespone[] execute(@RequestBody Author01Request request) {
		Author01Response response = pm.execute(request);
	...
	@Override
	public void postProcess(Author01Request request, Author01Response response) {
